          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              {state.connectedWallet ? (
                <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#1a1a24] border border-[#2a2a3a]">
                ...
                <button
                  ...
                  className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#1a1a24] border border-[#2a2a3a] hover:border-[#bf00ff]/50 transition-colors text-sm text-gray-400 hover:text-[#bf00ff]"
                >
                  <Wallet size={14} />
                  Connect
                </button>
