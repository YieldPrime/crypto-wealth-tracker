...
function LoadingScreen() {
  return (
    ...
    >
      ...
      >
        <Logo size={100} animate={true} showText={false} />
        
        <motion.h1 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.3 }}
          className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-[#39ff14] to-[#bf00ff] bg-clip-text text-transparent mt-6 mb-2"
        ...
        >
          Your crypto wealth journey starts here
        </motion.p>
...
function AppContent() {
  ...
  if (state.authLoading || isLoading) {
